...
*/
$ngay_dau_nam_nay = date("Y") . "-" . "1-1";
$ngay_cuoi_nam_nay = date("Y-m-d",strtotime('last day of this year', time()));

$ds_sach_ban_chay_nhat = $xl_sach->danh_sach_sach_ban_chay_nhat_theo_thoi_gian($ngay_dau_nam_nay, $ngay_cuoi_nam_nay);
?>
